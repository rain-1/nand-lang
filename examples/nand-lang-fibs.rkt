...
function main()
{
    ...
    while not(equal8(v1, v2, v3, v4, v5, v6, v7, v8, 0, 0, 0, 0, 1, 1, 1, 0)) {
        ...
        u = putc(0, 1, 0, 0, 0, 1, 1, 0); // F
        u = putc(0, 1, 1, 0, 1, 0, 0, 1); // i
        u = putc(0, 1, 1, 0, 0, 0, 1, 0); // b
        u = putc(0, 0, 1, 0, 0, 0, 0, 0); // space
        u = puti8(v1, v2, v3, v4, v5, v6, v7, v8);
        u = putc(0, 0, 1, 0, 0, 0, 0, 0); // space
        u = putc(0, 0, 1, 1, 1, 1, 0, 1); // = 
        u = putc(0, 0, 1, 0, 0, 0, 0, 0); // space
        u = puti8(fibonacci(v1, v2, v3, v4, v5, v6, v7, v8));
        u = endl();
        // increment
